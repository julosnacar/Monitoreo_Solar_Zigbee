...
#include "zcl/esp_zigbee_zcl_command.h"        // Needed for ZCL handlers and types
#include "ha/esp_zigbee_ha_standard.h"        // Standard HA definitions
#include "zcl/esp_zigbee_zcl_common.h"       // Common ZCL types
#include "zcl/esp_zigbee_zcl_analog_input.h"// Definitions for Analog Input cluster
